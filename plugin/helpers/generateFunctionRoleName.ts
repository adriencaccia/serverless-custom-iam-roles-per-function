...
const generateFunctionRoleName = ({ functionName, stage, service, region }: Params): string => {
  ...
  return completeFunctionRoleName.slice(0, MAX_AWS_LAMBDA_NAME_LENGTH - HASH_LENGTH) + hashedName;
};
